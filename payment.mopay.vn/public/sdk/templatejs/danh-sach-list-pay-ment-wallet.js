            ...
            if(!!self.data){
                ...
                if(!!arrItemPay.data) {
                    jsME.each(arrItemPay.data, function (key) {
                        ...
                        listHTML += '<div class="msdk_item innerFloat" id="item_list_payment_wallet_detail" gdata=' + self.opts.id_item_payment + '  gdata-detail=' + key + ' g-identify="' + identify + '" g-action-root="' + self.opts.g_action_root + '"  g-action="' + this.action + '"  g-action-end="' + self.opts.g_action + '" g-service="' + service_number + '" g-direct="0" >';
